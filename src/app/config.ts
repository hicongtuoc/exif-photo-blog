...
// STORAGE: DATABASE
export const HAS_DATABASE = true; // Always true for local JSON database
export const POSTGRES_SSL_ENABLED = false;
...
export const HAS_LOCAL_STORAGE = true;

export const HAS_MULTIPLE_STORAGE_PROVIDERS = false;

// Storage preference: always use local file system
export const CURRENT_STORAGE: StorageType = 'local-fs';
...
export const APP_CONFIGURATION = {
  ...
  hasStorageProvider: HAS_LOCAL_STORAGE,
